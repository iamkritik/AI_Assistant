...
# Heading Label
Label(root, text='My To Do List', bg='PaleVioletRed', font=("Comic Sans MS", 15), wraplength=300).place(x=35, y=0)
...
with open('C:\\Users\\HP\\My AI assistant\\ExtraPro\\shop.txt', 'r+') as tasks_list:
...
def add_item(entry: Entry, listbox: Listbox):
    ...
    with open('shop.txt', 'a') as tasks_list_file:
...
def delete_item(listbox: Listbox):
    ...
    with open('shop.txt', 'r+') as tasks_list_file:
